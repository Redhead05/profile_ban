      ...
      <div class="container" data-aos="fade-up">
        <div class="row justify-content-center">
          ...
          <div class="col-md-5 col-lg-3">
            <img src="{{  asset ('assets/img/about-img.png')}}" alt="About" data-aos="zoom-in" data-aos-delay="100">
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="screens-slider swiper-container">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="{{  asset ('assets/img/screen/1.jpg')}}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{  asset ('assets/img/screen/2.jpg')}}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{  asset ('assets/img/screen/3.jpg')}}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{  asset ('assets/img/screen/4.jpg')}}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{  asset ('assets/img/screen/5.jpg')}}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{  asset ('assets/img/screen/6.jpg')}}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{  asset ('assets/img/screen/7.jpg')}}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{  asset ('assets/img/screen/8.jpg')}}" class="img-fluid" alt=""></div>
          </div>
